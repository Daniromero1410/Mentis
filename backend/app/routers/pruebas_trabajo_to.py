...
# ═════════════════════════════════════════════════════════════════════
# GENERAR CONCEPTO CON IA
# ═════════════════════════════════════════════════════════════════════
@router.post("/{prueba_id}/generar-concepto")
def generar_concepto_ia(
    prueba_id: int,
    session: Session = Depends(get_session),
    current_user: Usuario = Depends(get_current_user),
):
    ...
    try:
        from app.services.groq_service import generar_concepto_pto
        resultado = generar_concepto_pto(
