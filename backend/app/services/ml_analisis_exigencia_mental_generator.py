"""
Sistema de Generación de Conceptos para Aes de Trabajo
...
# Si en el futuro divergen, importar de app.models.analisis_exigencia_mental
...
def generar_concepto_analisis_exigencia_mental(
    ...
    """
    Genera concepto para Aes de Trabajo con estilo específico del usuario.
    ...
    intro_base = (
        f"Del análisis de los resultados de la Ae de trabajo de esfera mental realizada a {variables_texto['nombre']}, "
    ...
    if severidad in ['bajo', 'sin_riesgo', 'riesgo_bajo']:
        ...
        conclusion_final = "En términos generales, el resultado de la Ae de trabajo de esfera mental sugiere un estado de estabilidad de las tareas asignadas."
    ...
    texto_legal = (
        "Una vez evaluado el cargo {cargo} mediante la realización de una Ae de trabajo de esfera mental, "
