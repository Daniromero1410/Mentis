          ...
          <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between anim-fade-in-up">
            <div className="flex items-center gap-3 sm:gap-4">
              ...
              <div>
                ...
                <p className="text-xs sm:text-sm text-gray-500 mt-0.5">Gestiona las pruebas de trabajo y evaluaciones de riesgos psicosociales</p>
              </div>
            </div>
            <Link href="/dashboard/pruebas-trabajo/nueva" className="w-full sm:w-auto">
            ...
            {loading ? (
              <div className="flex items-center justify-center h-64">
                <div className="flex flex-col items-center gap-3">
                  ...
                  <p className="text-sm text-gray-500 animate-pulse">Cargando pruebas...</p>
                </div>
              </div>
            ) : pruebas.length === 0 ? (
              <div className="flex flex-col items-center justify-center h-64">
                <div className="w-16 h-16 rounded-2xl bg-brand-50 flex items-center justify-center mb-4">
                  <Briefcase className="h-8 w-8 text-brand-300" />
                </div>
                <p className="text-base font-semibold text-gray-700">No hay pruebas de trabajo</p>
                <p className="text-sm text-gray-400 mt-1 mb-4">Crea una nueva prueba para comenzar</p>
                            ...
                            <div className="flex items-center gap-2 sm:gap-3">
                              ...
                              <div className="min-w-0">
                                ...
                                <span className="sm:hidden text-xs text-gray-400 truncate block">
                                  {prueba.trabajador_identificacion || '-'} · {prueba.empresa || '-'}
                                </span>
                              </div>
                            </div>
                          </td>
                          ...
                          <td className="px-3 py-3 sm:px-6 sm:py-4 whitespace-nowrap">
                            <div className="flex items-center justify-end gap-1">
                              <Link href={`/dashboard/pruebas-trabajo/${prueba.id}`}>
                                <Button variant="ghost" size="icon" className="h-8 w-8 text-brand-600 hover:text-brand-700 hover:bg-brand-50 rounded-lg">
