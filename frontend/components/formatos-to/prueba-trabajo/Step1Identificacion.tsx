        ...
        <div className="space-y-6">
            ...
            <FormSection title="1. IDENTIFICACIÓN DEL TRABAJADOR Y EMPRESA">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {/* Datos Trabajador */}
                    <div className="col-span-full font-semibold text-slate-700 border-b pb-2 mb-2">Datos del Trabajador</div>
                    ...
                    <FormField label="Nivel Educativo" className="col-span-full">
                        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3 mt-2">
                            {[
                                ...
                                <label key={item.val} className="flex items-center gap-2 text-sm text-slate-600 cursor-pointer p-2 border rounded-md hover:bg-slate-50">
                                    <input
                                        type="radio"
                                        name="educacion"
                                        value={item.val}
                    ...
                    {/* Datos ATEL y Empresa */}
                    <div className="col-span-full font-semibold text-slate-700 border-b pb-2 mb-2 mt-4">Datos del Evento y Empresa</div>
                    ...
                    <FormField label="Cargo Único (mismas características)">
                        <div className="flex gap-4 mt-2">
                            {['Si', 'No'].map((opt) => (
                                <label key={opt} className="flex items-center gap-2 text-sm text-slate-600 cursor-pointer border px-3 py-1 rounded-md hover:bg-slate-50">
                                    <input
                                        type="radio"
                                        name="cargo_unico"
                                        value={opt}
                    ...
                    <FormField label="Modalidad Trabalho">
