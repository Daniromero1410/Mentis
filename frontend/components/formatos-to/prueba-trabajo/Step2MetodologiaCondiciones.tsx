                ...
                <div className="grid grid-cols-2">
                    ...
                    <div className="border-r border-gray-800">
                        <FormRow className="border-b border-gray-800">
                            <FormField label="Jornada" className="w-32 font-bold" />
                            <FormInput
                        ...
                        <FormRow className="border-b border-gray-800">
                            <FormField label="Descansos programados" className="w-32 font-bold" />
                            <FormInput
                        ...
                        <FormRow className="border-b border-gray-800">
                            <FormField label="Tiempos efectivos en la jornada laboral" className="w-32 font-bold" />
                            <FormInput
                        ...
                        <FormRow noBorderBottom>
                            <FormField label="Horas extras" className="w-32 font-bold" />
                            <FormInput
                    ...
                    <div>
                        <FormRow className="border-b border-gray-800">
                            <FormField label="Ritmo" className="w-32 font-bold" />
                            <FormInput
                        ...
                        <FormRow className="border-b border-gray-800">
                            <FormField label="Turnos" className="w-32 font-bold" />
                            <FormInput
                        ...
                        <FormRow className="border-b border-gray-800">
                            <FormField label="Rotaciones" className="w-32 font-bold" />
                            <FormInput
                        ...
                        <FormRow noBorderBottom>
                            <FormField label="Distribución semanal" className="w-32 font-bold" />
                            <FormInput
