    ...
    return (
        <div className="space-y-6">
            ...
            <FormSection title="3. CONDICIONES DE TRABAJO">
                <div className="space-y-6">
                    <FormField label="3.1 DESCRIPCIÓN DEL PROCESO PRODUCTIVO">
                        <FormTextarea
                    ...
                    <FormField label="3.2 APRECIACIÓN DEL TRABAJADOR FRENTE A SU PROCESO PRODUCTIVO">
                        <FormTextarea
                    ...
                    <FormField label="3.3 ESTÁNDARES DE PRODUCTIVIDAD ESTABLECIDO POR LA EMPRESA">
                        <FormTextarea
                            className="min-h-[80px]"
