    ...
    const buildPayload = (finalizar: boolean) => {
        return {
            identificacion: {
                ...
                nivel_educativo: formData.escolaridad,
                telefonos_trabajador: formData.telefono,
                ...
                cargo_actual: formData.cargo_empresa,
                ...
                contacto_empresa: formData.jefe_inmediato, // Mapped from jefe_inmediato
                correos_electronicos: formData.correos_electronicos,
                telefonos_empresa: formData.telefono_jefe,
