...
export function PruebaTrabajoTOWizard({ mode, id, readOnly = false }: PruebaTrabajoTOWizardProps) {
    ...
    const [formData, setFormData] = useState({
        ...
        edad: '',
        genero: '',
        nivel_educativo: '', // Renamed from escolaridad
        cargo_actual: '', // Renamed from cargo_empresa previously
        antiguedad_cargo: '',
        antiguedad_empresa: '',
        telefonos_trabajador: '', // Renamed from telefono
        direccion_residencia: '', // Renamed from direccion
        dominancia: '',
        estado_civil: '',
        diagnosticos_atel: '',
        fechas_eventos_atel: '',
        ...
        direccion_empresa: '',
        empresa: '',
        contacto_empresa: '', // Renamed from jefe_inmediato previously
        telefonos_empresa: '', // Renamed from telefono_jefe
        cargo_jefe: '',
        objetivo_prueba: '',
        metodologia: '',
    ...
    const buildPayload = (finalizar: boolean) => {
        return {
            ...
            // Assuming tareas, materiales, peligros are already in correct format or handled elsewhere if needed
