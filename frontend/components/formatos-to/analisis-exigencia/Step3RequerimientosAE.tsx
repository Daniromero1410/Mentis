            ...
            <div className="mb-4">
                ...
                <div className="mb-10">
                    <div className="flex justify-between items-center mb-4 bg-slate-100 p-3 rounded-md">
                        <h3 className="text-sm font-bold text-slate-700 uppercase">
                            Identificación de materiales, equipos y herramientas en el proceso productivo
                        </h3>
                        {!readOnly && (
                            <Button onClick={addMaterial} size="sm" className="bg-indigo-600 hover:bg-indigo-700 text-white">
                ...
                <div className="mb-6">
                    <div className="flex justify-between items-center mb-4 bg-slate-100 p-3 rounded-md">
                        ...
                        {!readOnly && (
                            <Button onClick={addTarea} size="sm" className="bg-indigo-600 hover:bg-indigo-700 text-white">
